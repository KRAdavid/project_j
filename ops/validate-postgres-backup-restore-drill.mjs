...
for (const token of ['DATABASE_URL', 'DATABASE_ADMIN_URL', 'BACKUP_DRILL_EVIDENCE_PATH', 'writeEvidence', 'pg_dump', 'pg_restore', 'ledger_snapshots', 'operational_approvals', 'reserve_lot', 'drop database if exists']) {
