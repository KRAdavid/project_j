...
for (const table of ['organizations', 'supplier_verification_requests', 'supplier_prechecks', 'organization_members', 'materials', 'specifications', 'lots', 'evidences', 'offers', 'purchase_orders', 'reservations', 'trades', 'trade_inspections', 'trade_events', 'operational_approvals', 'approval_events', 'price_observations']) {
