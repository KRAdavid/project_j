...
const assertions = [
  ...
  ['workflow validates company supervisor recovery and attach mode', workflow.includes('node ops/test-company-supervisor.mjs') && workflow.includes('node ops/test-company-supervisor-integration.mjs') && workflow.includes('node ops/test-company-supervisor-attach.mjs')],
