...
const productionEnv = {
  ...
  AUTH_PROVIDER_READY: 'true', AUTH_EMAIL_VERIFICATION_READY: 'true', AUTH_JWT_SECRET: 'test-secret-that-is-at-least-32-bytes-long', AUTH_JWT_ISSUER: 'issuer', AUTH_JWT_AUDIENCE: 'audience',
  BUSINESS_REGISTRATION_PROVIDER_READY: 'true', BUSINESS_REGISTRATION_PROVIDER_URL: 'https://provider.example/verify', BUSINESS_REGISTRATION_PROVIDER_API_KEY: 'provider-test-key-1234',
